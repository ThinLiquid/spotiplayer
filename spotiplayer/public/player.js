  ...
  fetch("https://api.spotify.com/v1/me/player/currently-playing?market=GB", {
    ...
    .then(data => {
      if (data.currently_playing_type === "ad") {
        ...
        document
          .querySelector(".determinate.green")
          .setAttribute(
            "style",
            `width:${parseInt(data.progress_ms) / 1500}%;`
          );
        ...
        document
          .querySelector(".album")
          .setAttribute("src", data.item.album.images[0].url);
        ...
        document
          .querySelector(".determinate.green")
          .setAttribute("style", `width:${data.progress_ms / 500}px;`);
        document
          .querySelector(".progress")
          .setAttribute("style", `width:${data.item.duration_ms / 500}px;`);
        $(".progresser").text(millisToMinutesAndSeconds(data.progress_ms));
